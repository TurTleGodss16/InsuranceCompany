...
public class UpdateAdminUI extends javax.swing.JFrame {
    ...
    public UpdateAdminUI(InsurancePolicies policy, AdminUI UI) {
        this.policy = policy;
        this.adminUI = UI;
    ...
    this.commentAgeText.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent evt) {
            UpdateAdminUI.this.commentAgeTextActionPerformed(evt);
          }
        });
    ...
    this.thirdpartyChoice.addChangeListener(new ChangeListener() {
          public void stateChanged(ChangeEvent evt) {
            UpdateAdminUI.this.thirdpartyChoiceStateChanged(evt);
          }
        });
    ...
    this.jButton1.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent evt) {
            UpdateAdminUI.this.jButton1ActionPerformed(evt);
          }
        });
    ...
    this.jButton2.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent evt) {
            UpdateAdminUI.this.jButton2ActionPerformed(evt);
          }
        });
    ...
    private void initComponents() {
        ...
        modelText.setText("jTextField2");

        monthText.setText("jTextField3");

        numberOfClaimsText.setText("jTextField4");

        policyIDText.setText("jTextField5");

        policyUsernameText.setText("jTextField6");

        priceText.setText("jTextField7");

        yearText.setText("jTextField8");
